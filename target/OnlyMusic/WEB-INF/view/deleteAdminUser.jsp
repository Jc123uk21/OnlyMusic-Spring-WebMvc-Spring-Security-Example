...
<!-- add form to collect admin details -->
<div class = "findCustomerForm">
<form:form action = "deleteAdministrator" method = "POST" class = "formContainer">
<h3>Delete Administrator By Username</h3>
<label>Administrator's Username: </label><input type = "email" name = "email">
